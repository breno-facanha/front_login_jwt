...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push('/home'); // redirecionar para a página de animes
    } catch (error) {
  ...
  return (
    <>
      <Head>
        <title>Animes v3 - Login</title>
        <meta name="description" content="Faça login para acessar a plataforma de animes" />
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm text-blue-600 hover:text-blue-500 transition duration-200" title='Em desenvolvimento'>
                  Esqueceu a senha?
                </a>
              </div>
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              © 2025 Breno Façanha. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </div>
